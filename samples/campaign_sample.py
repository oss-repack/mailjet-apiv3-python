...
def create_a_campaign_draft() -> Client:
...
def by_adding_custom_content() -> Client:
...
def schedule_the_sending() -> Client:
...
if __name__ == "__main__":
    result: Client = create_a_campaign_draft()
